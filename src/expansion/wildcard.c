...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/14 14:42:35 by sdalaty           #+#    #+#             */
/*   Updated: 2024/09/14 14:55:05 by sdalaty          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		match_expr(t_regex *regex, t_bool **dp_arr, char *eval,
					char *pattern);
...
static t_bool	**alloc_table(t_regex *regex)
{
	...
	{
		dp_arr[index] = ft_calloc(regex->write_index + 1, sizeof(t_bool));
		index++;
	}
	return (dp_arr);
}
